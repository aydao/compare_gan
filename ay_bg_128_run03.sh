...
while true; do
  timeout --signal=SIGTERM 19h python3 wrapper.py compare_gan/main.py --gin_config ./example_configs/ay_bgm_danbooru128_run03.gin --use_tpu --tfds_data_dir 'gs://ay1-euw4a/datasets/' "$@"
  sleep 30
done
